...
import com.teslamotors.protocol.to2ByteArray
...
class AddKeyToWhiteListRequest {
    ...
    fun perform(pubKey: ByteArray): ByteArray {
        ...
        Log.d(TAG, "perform: byteStr: ${Utils.bytesToHex(unsignedMessageByteS.toByteArray())}")
        ...
        // 打印检查
        Log.d(TAG, "add key to white list perform: ${Utils.bytesToHex(requestBytes)}")
